...
#[tauri::command]
pub fn list_calendar_events(database: State<'_, Database>) -> Result<Vec<CalendarEvent>, String> {
...
#[tauri::command]
pub fn delete_calendar_event(database: State<'_, Database>, id: String) -> Result<(), String> {
    CalendarEventRepository::new(&database)
        .soft_delete(&id)
        .map_err(|error| error.to_string())
}
